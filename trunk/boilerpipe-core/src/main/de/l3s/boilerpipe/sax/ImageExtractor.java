...
public class ImageExtractor {
	...
	public List<String> getEnclosedImages(final TextDocument doc,
			final String origHTML) throws BoilerpipeProcessingException {
		return getEnclosedImages(doc, new InputSource(
	...
	public List<String> getEnclosedImages(final URL url, final BoilerpipeExtractor extractor)
		...
		return getEnclosedImages(doc, is);
	}
	

	private final class Implementation extends AbstractSAXParser implements
			ContentHandler {
		List<String> linksHighlight = new ArrayList<String>();
		private List<String> linksBuffer = new ArrayList<String>();
